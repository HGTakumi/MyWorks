...
class ClassifierWardOrderN(Classifier):
    ...
    def __initialize(self):
        ...
        def __initialize_centroids(self):
            ...
            centroids_current = [ClassifierWardOrderN.__compute_cluster_centroid(self.X_clusters[i_cluster])
                                 for i_cluster in range(self.n_clusters_start)]

            centroids_premerge = [ClassifierWardOrderN.__compute_cluster_centroid(np.concatenate([self.X_clusters[i_cluster], self.X_clusters[i_cluster + 1]]))
                                  for i_cluster in range(self.n_clusters_start-1)]
    ...
    def __compute_centroids(self):
        ...
        self.centroids_premerge.insert(self.index_min_distance - 1,
                                       ClassifierWardOrderN.__compute_cluster_centroid(np.concatenate([self.X_clusters[self.index_min_distance - 1], self.X_clusters[self.index_min_distance]])))
        self.centroids_premerge.insert(self.index_min_distance,
                                       ClassifierWardOrderN.__compute_cluster_centroid(np.concatenate([self.X_clusters[self.index_min_distance], self.X_clusters[self.index_min_distance + 1]])))
    ...
    def __run_head_exception(self):
        ...
        def __compute_centroids_head_ex(self):
            ...
            self.centroids_premerge.insert(0, ClassifierWardOrderN.__compute_cluster_centroid(np.concatenate([self.X_clusters[0], self.X_clusters[1]])))
    ...
    def __run_tail_exception(self):
        ...
        def __compute_centroids_tail_ex(self):
            ...
            self.centroids_premerge.insert(self.index_min_distance - 1,
                                           ClassifierWardOrderN.__compute_cluster_centroid(np.concatenate(
...
class ClassifierWardOrderD(Classifier):
    ...
    def __compute_centroids(self):
        ...
        self.centroids_current = np.array([ClassifierWardOrderD.__compute_cluster_centroid(self.X_clusters[i_cluster])
                                           for i_cluster in range(self.n_clusters_current)])

        self.centroids_premerge = np.array([ClassifierWardOrderD.__compute_cluster_centroid(
